...
export const MS_CLIENT_ID = process.env.MS_CLIENT_ID || envConfig.MS_CLIENT_ID;
export const MS_TENANT_ID = process.env.MS_TENANT_ID || envConfig.MS_TENANT_ID;
...
export const WEBHOOK_URL =
  ...
  envConfig.WEBHOOK_URL ||
  'https://cody.dreamind.cz/webhook/graph';
export const WEBHOOK_CERT_PATH =
  process.env.WEBHOOK_CERT_PATH ||
  envConfig.WEBHOOK_CERT_PATH ||
  '/etc/letsencrypt/live/cody.dreamind.cz/fullchain.pem';
export const WEBHOOK_KEY_PATH =
  process.env.WEBHOOK_KEY_PATH ||
  envConfig.WEBHOOK_KEY_PATH ||
  '/etc/letsencrypt/live/cody.dreamind.cz/privkey.pem';
